...
fig1_phase_mu_sigma.png         Figure 1
fig2_frontier_q_f.png           Figure 2
...
python run_phase_diagram.py       # ~3 min; writes fig1/fig2 PNGs and prints Tables 5–8
...
To rebuild the paper: `npm install docx` then `node build_paper.js`. Requires the two PNGs in the same directory.
